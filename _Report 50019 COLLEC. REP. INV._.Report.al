report 50019 "Report 50019 COLLEC. REP. INV."
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportExt/COLLECTION REPORT PER INVOICE.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'COLLECTION REPORT PER INVOICE'; //Ok
    ...
    dataset
    {
        dataitem(DataItem1; "Cust. Ledger Entry")
        {
            ...
            dataitem(DetailedCustLedger; Integer)
            {
                ...
                begin
                    IF Number = 1 THEN tempCustLedg.FIND('-')
                    ELSE
                        tempCustLedg.NEXT;
    ...
    var tempCustLedg: Record "Detailed Cust. Ledg. Entry" temporary;
    ...
    begin
        ...
        IF DtldCustLedgEntry1.FIND('-')THEN REPEAT IF DtldCustLedgEntry1."Cust. Ledger Entry No." = DtldCustLedgEntry1."Applied Cust. Ledger Entry No." THEN BEGIN
                    ...
                    IF DtldCustLedgEntry2.FIND('-')THEN REPEAT IF DtldCustLedgEntry2."Cust. Ledger Entry No." <> DtldCustLedgEntry2."Applied Cust. Ledger Entry No." THEN BEGIN
                                ...
                                IF tempCustLedg."Entry Type" <> tempCustLedg."Entry Type"::"Initial Entry" THEN IF tempCustLedg.INSERT THEN;
                            END;
