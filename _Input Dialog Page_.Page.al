page 50065 "Input Dialog Page"
{
    // version NAVW111.00
    CaptionML = ENU = 'Input Dialog', SQI = 'Input Dialog';
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                CaptionML = ENU = 'General', SQI = 'General';
